...
/// ```toml
/// [dependencies]
/// serde_jsonc2 = { version = "1.0", features = ["raw_value"] }
/// ```
///
/// # Example
///
...
/// use serde_jsonc2::{Result, value::RawValue};
///
/// #[derive(Deserialize)]
/// struct Input<'a> {
///     code: u32,
...
/// //
/// // This could be done equivalently using serde_jsonc2::Value as the type for
...
///     let input: Input = serde_jsonc2::from_str(input)?;
///
///     let output = Output {
///         info: (input.code, input.payload),
///     };
///
///     serde_jsonc2::to_string(&output)
/// }
///
/// fn main() -> Result<()> {
...
/// [`serde_jsonc2::from_str`] and [`serde_jsonc2::from_slice`] which support
/// borrowing from the input data without memory allocation.
///
/// When deserializing through [`serde_jsonc2::from_reader`] you will need to use
...
///
/// [`serde_jsonc2::from_str`]: ../fn.from_str.html
/// [`serde_jsonc2::from_slice`]: ../fn.from_slice.html
/// [`serde_jsonc2::from_reader`]: ../fn.from_reader.html
///
/// ```
/// # use serde::Deserialize;
/// # use serde_jsonc2::value::RawValue;
...
impl RawValue {
    ...
    ///
    /// This function is equivalent to `serde_jsonc2::from_str::<Box<RawValue>>`
    ...
    ///     let response: Response = serde_jsonc2::from_str(input)?;
    ///
...
/// // Local crate
/// use serde::Serialize;
/// use serde_jsonc2::value::{to_raw_value, RawValue};
///
/// #[derive(Serialize)]
/// struct MyExtraData {
///     a: u32,
...
/// };
/// # assert_eq!(
/// #     serde_jsonc2::to_value(my_thing).unwrap(),
/// #     serde_jsonc2::jsonc!({
/// #         "foo": "FooVal",
/// #         "bar": null,
/// #         "extra_data": { "a": 1, "b": 2 }
...
///
/// println!("{}", serde_jsonc2::value::to_raw_value(&map).unwrap_err());
/// ```
#[cfg_attr(docsrs, doc(cfg(feature = "raw_value")))]
...
pub const TOKEN: &str = "$serde_jsonc2::private::RawValue";

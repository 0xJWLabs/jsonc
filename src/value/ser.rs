...
///
/// This is the serializer that backs [`serde_jsonc2::to_value`][crate::to_value].
/// Unlike the main serde_jsonc2 serializer which goes from some serializable
...
/// ```
/// use serde::Serialize;
/// use serde_jsonc2::{Error, Value};
///
/// pub fn to_value<T>(input: T) -> Result<Value, Error>
/// where
///     T: Serialize,
/// {
///     input.serialize(serde_jsonc2::value::Serializer)
/// }
/// ```
